...
class main extends AWS_CONTROLLER
{
	...
	public function index_square_action()
	{
		...
		$this->crumb(AWS_APP::lang()->_t('笔记'), '/article/');
		...
		{
			unset($article_list);
			$article_list = $this->model('article')->get_articles_list(null, 1, 10, 'votes DESC', 30);
		}
		...
		TPL::assign('posts_list_bit', TPL::output('article/ajax/list', false));
